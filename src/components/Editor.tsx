...
import { caretPos } from "@/components/editor/editorText";
...
export default function Editor({
  ...
  // Textarea command layer: right-click menu, slash menu, ⌘K→link, smart lists.
  const {
    ctxMenu,
    setCtxMenu,
    slash,
    ...
    copySelection,
    chooseSlash,
  } = useEditorCommands({ wrapRef, content, setContent, title, templates });
